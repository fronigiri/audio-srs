...
func testScheduler(t *testing.T) {
	cases := []struct {
		...
		// normal test
		{
			card:             database.Card{Repetition: 5, Interval: 4, EF: 2.5},
			rating:           4,
			expectedInterval: 10,
			expectedEF:       2.5,
		},
		// forgotten card
		{
			card:             database.Card{Repetition: 1, Interval: 6, EF: 2.5},
			rating:           2,
			expectedInterval: 1,
			expectedEF:       2.18,
		},
		...
		{
			card:             database.Card{Repetition: 5, Interval: 1, EF: 1},
			rating:           3,
			expectedInterval: 1,
			expectedEF:       1.3,
		},
		...
		{
			card:             database.Card{Repetition: 0, Interval: 1, EF: 1.3},
			rating:           3,
			expectedInterval: 1,
			expectedEF:       1.3,
		},
		...
		{
			card:             database.Card{Repetition: 1, Interval: 1, EF: 1.3},
			rating:           3,
			expectedInterval: 6,
			expectedEF:       1.3,
		},
		...
		{
			card:             database.Card{Repetition: 2, Interval: 6, EF: 1.3},
			rating:           3,
			expectedInterval: 8,
			expectedEF:       1.3,
		},
